...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery__ = __webpack_require__(155);
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.onTriggerClick = function (link) {
        if (location.pathname.replace(/^\//, '') == link.pathname.replace(/^\//, '') && location.hostname == link.hostname) {
            var target = __WEBPACK_IMPORTED_MODULE_1_jquery__(link.hash);
            target = target.length ? target : __WEBPACK_IMPORTED_MODULE_1_jquery__('[name=' + link.hash.slice(1) + ']');
            if (target.length) {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_1_jquery__('.js-scroll-trigger').click(function () {
            __WEBPACK_IMPORTED_MODULE_1_jquery__('.navbar-collapse').collapse('hide');
        });
        // // Activate scrollspy to add active class to navbar items on scroll
        __WEBPACK_IMPORTED_MODULE_1_jquery__('body').scrollspy({
            target: '#sideNav'
        });
    };
    return AppComponent;
